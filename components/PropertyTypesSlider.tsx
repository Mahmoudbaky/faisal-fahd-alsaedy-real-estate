...
const propertyTypes = [
  ...
  {
    id: 7,
    name: "العمائر التجارية و السكنية",
    icon: Warehouse,
  ...
  {
    id: 9,
    name: "المجمعات التجارية",
    icon: Warehouse,
    description: "مجمعات تجارية تضم متاجر ومطاعم",
    gradient: "from-yellow-400 to-orange-500",
  },
  {
    id: 10,
    name: "المزارع المنتجة",
    icon: Warehouse,
    description: "مزارع تنتج محاصيل عالية الجودة",
    gradient: "from-yellow-400 to-orange-500",
  },
   {
    id: 11,
    name: "المنتجعات",
    icon: Warehouse,
    description: "منتجعات فاخرة تقدم خدمات متميزة",
    gradient: "from-yellow-400 to-orange-500",
  },
]
